...
var useUserBookmarks = function () {
    ...
    var _b = (0, react_1.useState)(0), refreshToken = _b[0], setRefreshToken = _b[1];
    var _c = (0, react_1.useState)([]), bookmarksState = _c[0], setBookmarksState = _c[1];
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (bookmark) {
                        ...
                        setRefreshToken(function (prev) { return prev + 1; });
                    }
                    return [2 /*return*/];
            }
        });
