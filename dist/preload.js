...
var getBookmarks = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, electron_1.ipcRenderer.invoke(electronEvents_1.ElectronEvents.GetBookmarks)];
        case 1: return [2 /*return*/, _a.sent()];
    }
}); }); };
var selectFolder = function () { return __awaiter(void 0, void 0, void 0, function () {
    var folderPath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, electron_1.ipcRenderer.invoke(electronEvents_1.ElectronEvents.SelectFolder)];
            case 1:
                folderPath = (_a.sent())[0];
                if (!folderPath)
